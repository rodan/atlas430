/*
  ...
  generated on Tue Jan  4 14:23:49 UTC 2022
*/
...
void spi_uca0_pin_init(void)
{
 ...
 || defined (__MSP430FR60431__) || defined (__MSP430FR6043__)
    ...
    P2SEL1 &= ~(BIT6 | BIT7);
    P2SEL1 |= BIT2;
    P4SEL0 |= BIT1 | BIT3 | BIT4;
    P4SEL1 &= ~(BIT1 | BIT3 | BIT4);
...
#else
    #warning "SPI_USES_UCA0 was defined but pins not known in 'glue/MSP430FR5xx_6xx/spi_uca0_pin.c'"
#endif
