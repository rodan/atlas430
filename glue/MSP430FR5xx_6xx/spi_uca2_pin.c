/*
  ...
  generated on Tue Jan  4 14:24:18 UTC 2022
*/
...
void spi_uca2_pin_init(void)
{
 ...
 || defined (__MSP430FR60431__) || defined (__MSP430FR6043__)
    ...
    PJSEL0 |= BIT0 | BIT2 | BIT3;
    PJSEL1 &= ~(BIT0 | BIT2 | BIT3);
#warning multiple pins found for the UCA2CLK function, you must initialize them manually
#warning multiple pins found for the UCA2SIMO function, you must initialize them manually
#warning multiple pins found for the UCA2SOMI function, you must initialize them manually
...
#else
    #warning "SPI_USES_UCA2 was defined but pins not known in 'glue/MSP430FR5xx_6xx/spi_uca2_pin.c'"
#endif
