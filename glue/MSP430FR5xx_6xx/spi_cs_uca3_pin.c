/*
  chip select pin setup for the spi UCA3 slave subsystem. 
  this file is generated automatically based on the device datasheets
  Author:          Petre Rodan <2b4eda@subdimension.ro>
  Available from:  https://github.com/rodan/atlas430

  generated on Fri Mar 11 19:04:52 UTC 2022
*/

#include <msp430.h>

void spi_cs_uca3_pin_init(void)
{
...
#warning function UCA3STE not found for this uC
...
#else
    #warning "SPI_USES_UCA3 was defined but CS pins not known in 'glue/MSP430FR5xx_6xx/spi_cs_uca3_pin.c'"
#endif
