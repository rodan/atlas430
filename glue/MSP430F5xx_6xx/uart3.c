...
void uart3_init(void)
{
    ...
    #if UART3_BAUD == 9600
    UCA3CTL1 |= UC_CTL1;
    UCA3BR0 = BR_9600_BAUD & 0xff;
    UCA3BR1 = (BR_9600_BAUD >> 8) & 0xff;
    UCA3MCTL = MCTL_9600_BAUD;

    #elif UART3_BAUD == 19200
    UCA3CTL1 |= UC_CTL1;
    UCA3BR0 = BR_19200_BAUD & 0xff;
    UCA3BR1 = (BR_19200_BAUD >> 8) & 0xff;
    UCA3MCTL = MCTL_19200_BAUD;

    #elif UART3_BAUD == 38400
    UCA3CTL1 |= UC_CTL1;
    UCA3BR0 = BR_38400_BAUD & 0xff;
    UCA3BR1 = (BR_38400_BAUD >> 8) & 0xff;
    UCA3MCTL = MCTL_38400_BAUD;

    #elif UART3_BAUD == 57600
    UCA3CTL1 |= UC_CTL1;
    UCA3BR0 = BR_57600_BAUD & 0xff;
    UCA3BR1 = (BR_57600_BAUD >> 8) & 0xff;
    UCA3MCTL = MCTL_57600_BAUD;

    #elif UART3_BAUD == 115200
    UCA3CTL1 |= UC_CTL1;
    UCA3BR0 = BR_115200_BAUD & 0xff;
    UCA3BR1 = (BR_115200_BAUD >> 8) & 0xff;
    UCA3MCTL = MCTL_115200_BAUD;
