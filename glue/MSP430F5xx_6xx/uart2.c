...
void uart2_init(void)
{
    ...
    #if UART2_BAUD == 9600
    UCB0BR0 = BR_9600_BAUD & 0xff;
    UCB0BR1 = (BR_9600_BAUD >> 8) & 0xff;
    UCB0MCTL = MCTL_9600_BAUD;

    #elif UART2_BAUD == 19200
    UCB0BR0 = BR_19200_BAUD & 0xff;
    UCB0BR1 = (BR_19200_BAUD >> 8) & 0xff;
    UCB0MCTL = MCTL_19200_BAUD;

    #elif UART2_BAUD == 38400
    UCB0BR0 = BR_38400_BAUD & 0xff;
    UCB0BR1 = (BR_38400_BAUD >> 8) & 0xff;
    UCB0MCTL = MCTL_38400_BAUD;

    #elif UART2_BAUD == 57600
    UCB0BR0 = BR_57600_BAUD & 0xff;
    UCB0BR1 = (BR_57600_BAUD >> 8) & 0xff;
    UCB0MCTL = MCTL_57600_BAUD;

    #elif UART2_BAUD == 115200
    UCB0BR0 = BR_115200_BAUD & 0xff;
    UCB0BR1 = (BR_115200_BAUD >> 8) & 0xff;
    UCB0MCTL = MCTL_115200_BAUD;
    ...
    UCB0IE |= UCRXIE | UCTXIE;           // Enable USCI_A0 interrupts
...
void uart2_initb(const uint8_t baudrate)
{
    ...
    UCB0CTL1 &= ~UCSWRST;      // Initialize eUSCI
    UCB0IE |= UCRXIE;           // Enable USCI_A3 RX interrupt
