...
void uart2_init(void)
{
    ...
    #if UART2_BAUD == 9600
    UCA2CTL1 |= UC_CTL1;
    UCA2BR0 = BR_9600_BAUD & 0xff;
    UCA2BR1 = (BR_9600_BAUD >> 8) & 0xff;
    UCA2MCTL = MCTL_9600_BAUD;

    #elif UART2_BAUD == 19200
    UCA2CTL1 |= UC_CTL1;
    UCA2BR0 = BR_19200_BAUD & 0xff;
    UCA2BR1 = (BR_19200_BAUD >> 8) & 0xff;
    UCA2MCTL = MCTL_19200_BAUD;

    #elif UART2_BAUD == 38400
    UCA2CTL1 |= UC_CTL1;
    UCA2BR0 = BR_38400_BAUD & 0xff;
    UCA2BR1 = (BR_38400_BAUD >> 8) & 0xff;
    UCA2MCTL = MCTL_38400_BAUD;

    #elif UART2_BAUD == 57600
    UCA2CTL1 |= UC_CTL1;
    UCA2BR0 = BR_57600_BAUD & 0xff;
    UCA2BR1 = (BR_57600_BAUD >> 8) & 0xff;
    UCA2MCTL = MCTL_57600_BAUD;

    #elif UART2_BAUD == 115200
    UCA2CTL1 |= UC_CTL1;
    UCA2BR0 = BR_115200_BAUD & 0xff;
    UCA2BR1 = (BR_115200_BAUD >> 8) & 0xff;
    UCA2MCTL = MCTL_115200_BAUD;
