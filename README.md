...
effort has been put into trying to support arround 355 msp430 microcontrollers that belong to the f5xx_f6xx, fr2xx_4xx and fr5xx_6xx families by the use of scripts that automatically parse the device-specific datasheets.

the current compatibility table can be consulted [here](doc/tests/README.md).
