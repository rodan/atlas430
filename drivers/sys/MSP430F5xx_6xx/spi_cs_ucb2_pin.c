/*
  chip select pin setup for the spi UCB2 slave subsystem. 
  this file is generated automatically based on the device datasheets
  Author:          Petre Rodan <2b4eda@subdimension.ro>
  Available from:  https://github.com/rodan/atlas430

  generated on Fri Mar 11 11:46:26 UTC 2022
*/

#include <msp430.h>

void spi_cs_ucb2_pin_init(void)
{

#ifdef SPI_USES_UCB2

#if defined (__MSP430F5358__) || defined (__MSP430F5359__) \
...
#warning function UCB2STE not found for this uC
...
#else
    #warning "SPI_USES_UCB2 was defined but CS pins not known in 'glue/MSP430F5xx_6xx/spi_cs_ucb2_pin.c'"
#endif
