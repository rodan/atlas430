/*
  ...
  generated on Fri Mar 11 19:04:28 UTC 2022
*/
...
#warning function UCA1STE not found for this uC

#else
    #warning "SPI_USES_UCA1 was defined but CS pins not known in 'glue/MSP430FR2xx_4xx/spi_cs_uca1_pin.c'"
#endif
