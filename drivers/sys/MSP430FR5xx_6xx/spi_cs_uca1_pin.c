/*
  chip select pin setup for the spi UCA1 slave subsystem. 
  this file is generated automatically based on the device datasheets
  Author:          Petre Rodan <2b4eda@subdimension.ro>
  Available from:  https://github.com/rodan/atlas430

  generated on Fri Mar 11 19:04:46 UTC 2022
*/

#include <msp430.h>

void spi_cs_uca1_pin_init(void)
{
 ...
 || defined (__MSP430FR69891__) || defined (__MSP430FR6989__)
    ...
    P5SEL0 |= BIT7;
    P5SEL1 &= ~BIT7;
#warning multiple pins found for the UCA1STE function, you must initialize them manually
...
#else
    #warning "SPI_USES_UCA1 was defined but CS pins not known in 'glue/MSP430FR5xx_6xx/spi_cs_uca1_pin.c'"
#endif
