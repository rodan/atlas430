/*
  chip select pin setup for the spi UCA2 slave subsystem. 
  this file is generated automatically based on the device datasheets
  Author:          Petre Rodan <2b4eda@subdimension.ro>
  Available from:  https://github.com/rodan/atlas430

  generated on Fri Mar 11 19:04:50 UTC 2022
*/

#include <msp430.h>

void spi_cs_uca2_pin_init(void)
{
 ...
 || defined (__MSP430FR60431__) || defined (__MSP430FR6043__)
    ...
    PJSEL0 |= BIT1;
    PJSEL1 &= ~BIT1;
#warning multiple pins found for the UCA2STE function, you must initialize them manually
...
#warning function UCA2STE not found for this uC

#else
    #warning "SPI_USES_UCA2 was defined but CS pins not known in 'glue/MSP430FR5xx_6xx/spi_cs_uca2_pin.c'"
#endif
