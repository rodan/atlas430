/*
  pin setup for the i2c UCB3 subsystem. 
  this file is generated automatically based on the device datasheets
  Author:          Petre Rodan <2b4eda@subdimension.ro>
  Available from:  https://github.com/rodan/atlas430

  generated on Tue Jan  4 13:45:39 UTC 2022
*/

#include <msp430.h>

void i2c_ucb3_pin_init(void)
{
...
#warning function UCB3SCL not found for this uC
#warning function UCB3SDA not found for this uC

#else
    #warning "I2C_USES_UCB3 was defined but pins not known in 'glue/MSP430FR5xx_6xx/i2c_ucb3_pin.c'"
#endif
