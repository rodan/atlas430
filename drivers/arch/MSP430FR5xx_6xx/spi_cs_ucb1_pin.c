/*
  chip select pin setup for the spi UCB1 slave subsystem. 
  this file is generated automatically based on the device datasheets
  Author:          Petre Rodan <2b4eda@subdimension.ro>
  Available from:  https://github.com/rodan/atlas430

  generated on Fri Mar 11 19:05:02 UTC 2022
*/

#include <msp430.h>

void spi_cs_ucb1_pin_init(void)
{
...
#warning function UCB1STE not found for this uC
 ...
 || defined (__MSP430FR60471__) || defined (__MSP430FR6047__)
    ...
    P8SEL0 |= BIT7;
    P8SEL1 &= ~BIT7;
#warning multiple pins found for the UCB1STE function, you must initialize them manually
...
#else
    #warning "SPI_USES_UCB1 was defined but CS pins not known in 'glue/MSP430FR5xx_6xx/spi_cs_ucb1_pin.c'"
#endif
